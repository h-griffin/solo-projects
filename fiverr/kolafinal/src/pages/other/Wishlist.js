...
const Wishlist = ({
  ...
  const getpdetail = (product) => {
    setProduct(product);
    setDiscountedPrice(getDiscountPrice(product.price, product.discount));
    setFinalProductPrice(+(product.price * currency.currencyRate).toFixed(2));
  ...
  return (
    <Fragment>
      <MetaTags>
        <title>KolaMarket | Wishlist</title>
        <meta
          name="description"
                            ...
                            return (
                              <tr key={key}>
                                ...
                                <td className="product-wishlist-cart">
                                  ...
                                  <button
                                    className="active"
                                    onClick={() => getpdetail(wishlistItem)}
                                  >
                                    View Deal
                                  </button>
                                  &nbsp;&nbsp;
                                  <a
                                    className="active"
                                    href={wishlistItem.productshopurl}
                                    target="_blank"
                                  >
                                    Get Deal
                                  </a>
