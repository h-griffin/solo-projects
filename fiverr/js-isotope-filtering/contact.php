...
$from = '<sender@hermesmelissa.com>';  // ___@yourDomain.com

// an email address that will receive the email with the output of the form
$sendTo = '<melissahermes99@gmail.com>';
...
try
{
    ...
    $headers = array('Content-Type: text/plain; charset="UTF-8"; Access-Control-Allow-Origin: "*"',
        'From: ' . $from,
        'Reply-To: ' . $from,
        'Return-Path: ' . $from,
    );
